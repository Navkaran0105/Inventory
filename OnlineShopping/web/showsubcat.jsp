		...
		<div class="container">
            ...
            try
            {
                   ...
                   try
                   {
                        ...
                        String c = "select * from addsubcat where maincatid=?";
                        PreparedStatement myset =  myconn.prepareStatement(c);
                        myset.setString(1, request.getParameter("cid"));
                        ...
                        if(rs.next()==true)
                        {
                            ...
                            {   
                                ...
                                out.print("<td><a href='showprods.jsp?scid=" + rs.getString("subcatid") + "'><img src='uploads/"  + rs.getString("subcatpic") + "' width='75'><br/>" + rs.getString("subcatname") + "</a></td>");
                                count++;
                            }
                            while(rs.next());
                            out.print("</tr></table>");
