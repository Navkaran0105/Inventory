            ...
            try
            {
                   ...
                   try
                   {
                        ...
                        if(res.next()==true)
                        {
                            ...
                            do
                            {                     
                                out.print("<tr><td>" + res.getString("Name")+"</td><td><a href='updateocassion.jsp?oid=" + res.getString("id") + "'>Update</a></td><td><a class='mylink' href='#' id='" + res.getString("id") + "'>Delete</a></td>");
                            }
                            while(res.next());
                            out.print("</table>");
                        }
