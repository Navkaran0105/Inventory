        ...
        $.ajax(
		   ...
		   processData: false,
                    ...
                    success: function (reslt)
                    {
                        ...
                        {
                          $('#msg').html("Sub Category added successfully");   
                        } 
                        else if($.trim(reslt) == "CategoryN")
                        {
                             $('#msg').html("Sub Category not added successfully");
                        }
                        else
                        {
                             $('#msg').html(reslt);
...
<!-- mail -->
	<div class="mail">
        ...
        %>  
                    ...
                    <input placeholder="Sub Category Name" name="subcatname" type="text" required=""><br/><br/>	
                      
                        <input type="file" name="subcatpic" class="form-control">	
                        <div class="sign-up">
                            <input type="submit" value="Add Sub Category" name="submit"/>
                        </div><div id="msg"></div>
                </form>
        </div>
		</div>
