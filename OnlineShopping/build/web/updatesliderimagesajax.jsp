...
<%
        String opic="",imagename="",path="",oid="";
        ...
        if(isMultipart==true)
        {
           ...
           for(FileItem myitem:items)
           {
                if (myitem.isFormField())
                {
                    ...
                    if(itemName1.equals("oldpic")) //control's name - textbox name
                    {
                        opic=value;
                    }
                    else if(itemName1.equals("oldid")) //control's name - textbox name
                    {
                        oid=value;
                    }
               ...
               try
                {
                   ...
                   try
                   {
                        String q = "update addslider set sliderpic=? where srno=?";
                        PreparedStatement myst =  myconn.prepareStatement(q);
                       
                        myst.setString(1, imagename);
                        myst.setString(2, oid);
